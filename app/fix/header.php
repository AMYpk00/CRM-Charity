<header>
    ...
    <ul class="nav">
        <li><a class="hover" href="<?php echo BASE_URL . "/index.php" ?>">Home</a></li>
        ...
        <li><a class="hover" href="<?php echo BASE_URL . "/TH-index.php" ?>"><i class="fa-solid fa-earth-americas"></i></a></li>
